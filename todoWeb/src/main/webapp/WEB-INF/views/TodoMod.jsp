	...
	<div class="starter-template">
		...
		<div class="wrap">
			<table class="table table-hover">
				...
				<tr>
					<td>카테고리</td>
					<td><Select name="cate" style="width:150px" class="form-control floating-label" id="co">
					...
					<script>
					$('#co').val("<%=todo.getCategory()%>").prop('selected',true);
					</script>
				</tr>
				<tr>
					<td>제목</td><td>
			...
			<a href="TodoDel.do?idx=<%=todo.getIdx()%>"><input type="button" value="삭제" class="btn btn-danger"></a>
			<br>
			<br>
		</div><!-- wrap -->
		</form>
